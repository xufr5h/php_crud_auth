...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
  ...
  if ($finance_date && $finance_category && $finance_amount && $finance_payment_method) {
    $conn = new Database();
    $returnData = $conn->create("INSERT INTO finance (date, category, amount, payment_method, description, user_id) VALUES (?, ?, ?, ?, ?,?)", [$finance_date, $finance_category, $finance_amount, $finance_payment_method, $finance_description, $user_id]);
